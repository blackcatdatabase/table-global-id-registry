...
- Pkg folder: [packages\global-id-registry](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\global-id-registry)
...
graph LR
  ...
  global_id_registry["global_id_registry"]:::center
```
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package global-id-registry -Apply
