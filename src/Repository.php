...
{
    private GlobalIdRegistryRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new GlobalIdRegistryRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\GlobalIdRegistry\Dto\GlobalIdRegistryDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\GlobalIdRegistry\Dto\GlobalIdRegistryDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\GlobalIdRegistry\Dto\GlobalIdRegistryDto|null
    {
