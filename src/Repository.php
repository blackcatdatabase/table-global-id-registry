...
namespace BlackCat\Database\Packages\GlobalIdRegistry;
...
use BlackCat\Database\Packages\GlobalIdRegistry\Repository\GlobalIdRegistryRepository as GeneratedRepository;
...
{
  private GlobalIdRegistryRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof GlobalIdRegistryRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected GlobalIdRegistryRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\GlobalIdRegistry\Dto\GlobalIdRegistryDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\GlobalIdRegistry\Dto\GlobalIdRegistryDto|null { return $this->repo->getById($id, $asDto); }
