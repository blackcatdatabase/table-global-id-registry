...
final class GlobalIdRegistryModule implements ModuleInterface
{
    public function name(): string { return 'table-global_id_registry'; }
    public function table(): string { return 'global_id_registry'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_gid_guid', 'idx_gid_table' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_gid_guid', 'idx_gid_table' ],
            'foreignKeys' => [],
        ];
    }
}
