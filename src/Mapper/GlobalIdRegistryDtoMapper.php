...
namespace BlackCat\Database\Packages\GlobalIdRegistry\Mapper;

use BlackCat\Database\Packages\GlobalIdRegistry\Dto\GlobalIdRegistryDto;
use BlackCat\Database\Packages\GlobalIdRegistry\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO GlobalIdRegistryDto:
 ...
 */
final class GlobalIdRegistryDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'gid' => 'gid', 'guid' => 'guid', 'entity_table' => 'entityTable', 'entity_pk' => 'entityPk', 'created_at' => 'createdAt' ];
     ...
     * @return GlobalIdRegistryDto
     */
    public static function fromRow(array $row): GlobalIdRegistryDto
    {
        /** @var GlobalIdRegistryDto */
        return DtoHydrator::fromRow(
            GlobalIdRegistryDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?GlobalIdRegistryDto
    {
     ...
     *
     * @param GlobalIdRegistryDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(GlobalIdRegistryDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(GlobalIdRegistryDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(GlobalIdRegistryDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,GlobalIdRegistryDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,GlobalIdRegistryDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(GlobalIdRegistryDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,GlobalIdRegistryDto>
     */
